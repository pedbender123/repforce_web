...
const SysAdminLayout = () => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/sysadmin/dashboard', icon: <LayoutDashboard size={20} /> },
    { name: 'Tenants', path: '/sysadmin/tenants', icon: <Building2 size={20} /> },
    { name: 'Usuários', path: '/sysadmin/users', icon: <Users size={20} /> },
  ];
        ...
        <div className="p-4 border-t border-gray-800">
            {!isCollapsed ? (
                <>
                  <div className="flex items-center justify-between mb-4 px-2">
                     <div className="flex items-center text-gray-400">
                        ...
                        <span className="text-xs font-medium uppercase tracking-wider truncate">Root Access</span>
                     </div>
                ...
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <button
                        onClick={handleLogout}
                        className="text-red-400 hover:bg-red-900/30 p-2 rounded-lg transition-colors"
                        title="Sair"
                    >
                        <LogOut size={20} />
                    </button>
