...
const SysAdminLayout = () => {
  ...
  useEffect(() => {
    ...
    if (matchingAreas.length > 0) {
      ...
      // Senão, pega a primeira (priorizando custom areas se invertermos, mas aqui o padrão é system first. 
      // O bug do usuário era "muda para sysadmin". Vamos tentar pegar a mais especifica?
      // Simplesmente setar a primeira match deve resolver se o loop de "manter a atual" funcionar.
